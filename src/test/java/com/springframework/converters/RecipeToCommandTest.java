...
class RecipeToCommandTest {
    ...
    public static final Long ID_ING1 = 2L;
    public static final Long ID_ING2 = 3L;
    public static final Difficulty DIFFICULTY = Difficulty.MODERATE;
    public static final Long ID_NOTES = 4L;
    public static final Long ID_CAT1 = 5L;
    public static final Long ID_CAT2 = 6L;
