...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
       ...
       /* Optional<UnitOfMeasure> eachUomOpt = unitOfMeasureRepository.findByDescription("Each");
        ...
        guacRecipe.getIngredients().add(new Ingredient("lemon juice", new BigDecimal(1), tableSpoonUom, guacRecipe));
        ...
        tacosRecipe.getIngredients().add(new Ingredient("sour cream thinned with", new BigDecimal(0.5), cupsUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("milk", new BigDecimal(0.25), cupsUom, tacosRecipe));
