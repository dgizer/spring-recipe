...
public class IngredientController {
    ...
    public String addIngredient(@PathVariable String recipeId, Model model) {
        ...
        newIngr.setRecipeId(Long.valueOf(recipeId));
    ...
    @GetMapping
    @RequestMapping("recipe/{recId}/ingredient/{id}/delete")
    public String deleteIngredient(@PathVariable String recId,
                                   @PathVariable String id) {
        ingredientService.deleteIngredientById(Long.valueOf(recId),Long.valueOf(id));
